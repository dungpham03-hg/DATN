...
export const MEETING_PERMISSIONS = {
  CREATE: [USER_ROLES.ADMIN, USER_ROLES.MANAGER, USER_ROLES.SECRETARY],
  EDIT: [USER_ROLES.ADMIN, USER_ROLES.MANAGER, USER_ROLES.SECRETARY],
  DELETE: [USER_ROLES.ADMIN, USER_ROLES.MANAGER],
  APPROVE_ROOM: [USER_ROLES.ADMIN, USER_ROLES.SECRETARY, USER_ROLES.TECHNICIAN],
  APPROVE_PROTOCOL: [USER_ROLES.ADMIN, USER_ROLES.MANAGER, USER_ROLES.SECRETARY],
