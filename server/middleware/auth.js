...
// Middleware kiểm tra quyền manager hoặc admin hoặc secretary
...
// Middleware: technician hoặc admin/secretary
...
const checkDepartmentAccess = (req, res, next) => {
  ...
  // Admin và Secretary có quyền xem tất cả departments
